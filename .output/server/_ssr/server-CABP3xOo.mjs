...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-NRJ_PqO9.mjs");
...
const manifest = {
  "1633ae07f1af5b5428d73a21080e55bd7a717aa2438c36c590bdbed096c70354": {
    functionName: "updateRoomSettings_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "4f094df9e74a711c11d2262e7ce0362d372198697adf2e49f17b95d770d62f2b": {
    functionName: "submitGuess_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "72b0c82d5d00ffe5429d99e5e0d8b8f65301ff57d761bd4b80924342359a0e12": {
    functionName: "chooseWord_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "72ff94374307e72a03cde4028917799b829a2f6eed34e12870a966188fe9f057": {
    functionName: "createRoom_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "7320d41316c850aff257b2390af8f08c7deb896e0c7d4ef2730b55ed6562ac25": {
    functionName: "autoChooseWord_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "73323c0c70d5bc3d3dbbade43bfee15ad3ac64d8e1308ffab9ade34971c75436": {
    functionName: "leaveRoom_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "7b6f56b1689db5ebcbcd991a3cbc9d3702d92d7fb35dbff4e359e27f1f3a5a9f": {
    functionName: "startGame_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "970bdd3f08722f38c214425e409c5fb38598c4c0711e75df7a9dd9e746ff7743": {
    functionName: "resetGame_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "9e71869b63bc0d0ac1ea40b2e5096f6ef3c7481169d7d692c3f99543b35b1216": {
    functionName: "nextTurn_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "b42eb7bf4c698ca3c69ebf4d50154908d6abd91ae828afc627e358bdd16eebbc": {
    functionName: "revealLetter_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "c8a29b6780a974f63fb4e68fce38ee3cb8b0b336078d3173b8f13b64132bd127": {
    functionName: "listPublicRooms_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "cca29c9610d72d2bdb8ea45d1db21d450ab13bfe8a9f314c2ed446e640e68159": {
    functionName: "endRound_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "d8b9bc6ce64c74312bb0556b62400dc94581d9ce471af4daa1b67d7df916946c": {
    functionName: "joinRoom_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  },
  "e54962c1c28cba0ec44aca118430d62ad5b044758a7d83a3cb59f4f0900eec68": {
    functionName: "kickPlayer_createServerFn_handler",
    importer: () => import("./game.functions-05rnc9zO.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DOpT2GNU.mjs"),
    import("./start-DikslhWv.mjs"),
